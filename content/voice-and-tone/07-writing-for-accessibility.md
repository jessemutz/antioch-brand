...
metaDescription: 'Writing for Accessibility'
---
> At least 15% of internet users have some sort of disability.
...
<div class="box">
  <p><img src="../images/icons/no.svg" alt="Don't do this" class="icon" />“Select from the options in the right sidebar.”</p>
  <p><img src="../images/icons/yes.svg" alt="Do this" class="icon" />“Select from these options,” (with the steps listed after the title)</p>
</div>
...
Never use headers for styling purposes.
